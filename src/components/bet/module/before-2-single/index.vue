...
<template>
  <div>
    <div class="play-content">
      <div class="flex textareabox">
        <div class="textarea">
          <textarea v-model="textAreaV" placeholder="程序会自动过滤掉不合法的号码。您也可以点击“删除重复号”按钮对输入内容进行格式化。."></textarea>
        </div>
        <div class="btn-group">
          <Button type="warning" long @click="RemoveRet">删除重复号</Button>
          <Button type="warning" long @click="cleartextArea">清空</Button>
        </div>
      </div>  
    </div>
    <!-- 加倍区 -->
